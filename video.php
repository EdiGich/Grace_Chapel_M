...
?>
<div class="video_body"><!---video body-->

<div class="video_clip">
    <video  class="clip" src="clips/<?php echo $video ?>"controls></video>
</div>
...
<div class="other_videos"><!---other video-->

<div class="title_others"><h1>Other Sermons</h1></div>
<?php
$query = "SELECT * FROM sermons ORDER BY sermon_id DESC LIMIT 3";
$select_sermons = mysqli_query($conn,$query);
while($row = mysqli_fetch_assoc($select_sermons)){
  $sermon_id = $row['sermon_id'];
  $topic = $row['topic'];
 ...
 <div class="sermon_card"><!---sermon card-->
 <?php
